...
import de.javabegin.micro.planner.todo.repo.PriorityRepository;
...
public class PriorityService {
    ...
    public List<Priority> find(String title, Long userId, String color) {
        return repository.findByTitle(title, userId, color);
    }
