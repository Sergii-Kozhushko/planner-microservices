...
import de.javabegin.micro.planner.entity.Priority;
import de.javabegin.micro.planner.todo.search.PrioritySearchValues;
import de.javabegin.micro.planner.todo.service.PriorityService;
import de.javabegin.micro.planner.utils.rest.resttemplate.UserRestBuilder;
...
//
    ...
    public ResponseEntity<Priority> add(@RequestBody Priority priority) {
        ...
        return new ResponseEntity("User id = '" + priority.getUserId() +"' not found", HttpStatus.CONFLICT);
    }
    ...
    // поиск по любым параметрам de.javabegin.micro.planner.todo.search.PrioritySearchValues
    @PostMapping("/search")
    public ResponseEntity<List<Priority>> search(@RequestBody PrioritySearchValues prioritySearchValues) {
        ...
        return ResponseEntity.ok(priorityService.find(prioritySearchValues.getTitle(), prioritySearchValues.getUserId(), prioritySearchValues.getColor()));
    }
